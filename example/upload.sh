...
#
# If unspecifed, the destination is da1000.local and the .fw file is naively
# guessed
#
...
help() {
    ...
    echo
    echo "Default destination IP is 'da1000.local'"
...
[ -n "$DESTINATION" ] || DESTINATION=da1000.local
